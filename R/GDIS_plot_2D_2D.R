#' Plot GDIS 2D.2D plot
#'
#' This function plots a GDIS visualization based on GDIS parameters.

#' @param input_triangle_parameters the path to the RData GDIS output, which ends with 2D_2D.triangle_parameters.RData
...
GDIS_plot_2D_2D <- function(input_triangle_parameters, show.rendering = TRUE, webversion = FALSE, show.names = TRUE) {
...
#### Set up the environment and load data -----------------------------------------------------------
    ...
    # Show message
    cli::cli_h1(paste0("Running ", cli::col_cyan("GDIS plot 2D_2D"), " on ", cli::col_cyan(triangle_list$triangle1.filename), " with " , cli::col_cyan(triangle_list$triangle2.filename)))
...
#### Create 3D triangle --------------------------------------------------------------------------------
    ...
    fig <- plotly::plot_ly() %>%
      ...
      # Subsub line
      plotly::add_trace(x = c(triangle1.x.sub1, triangle1.x.sub2), y = c(triangle1.y.sub1, triangle1.y.sub2), z = c(triangle1.z.sub1, triangle1.z.sub2),
      ...
      # Subsub line
      plotly::add_trace(x = c(triangle2.x.sub1, triangle2.x.sub2), y = c(triangle2.y.sub1, triangle2.y.sub2), z = c(triangle2.z.sub1, triangle2.z.sub2),
                type = 'scatter3d', mode = 'lines',
      ...
      # sub2_con line
      plotly::add_trace(x = c(triangle1.x.sub2, triangle1.x.con), y = c(triangle1.y.sub2, triangle1.y.con), z = c(triangle1.z.sub2, triangle1.z.con),
                type = 'scatter3d', mode = 'lines',
      ...
      # sub2_con line
      plotly::add_trace(x = c(triangle2.x.sub2, triangle2.x.con), y = c(triangle2.y.sub2, triangle2.y.con), z = c(triangle2.z.sub2, triangle2.z.con),
                type = 'scatter3d', mode = 'lines',
      ...
      # sub1_con line
      plotly::add_trace(x = c(triangle1.x.con, triangle1.x.sub1), y = c(triangle1.y.con, triangle1.y.sub1), z = c(triangle1.z.con, triangle1.z.sub1),
                type = 'scatter3d', mode = 'lines',
      ...
      # sub1_con line
      plotly::add_trace(x = c(triangle2.x.con, triangle2.x.sub1), y = c(triangle2.y.con, triangle2.y.sub1), z = c(triangle2.z.con, triangle2.z.sub1),
                type = 'scatter3d', mode = 'lines',
      ...
      # Allcases line
      plotly::add_trace(x = c(triangle1.x.allcases, triangle1.x.con), y = c(triangle1.y.con, triangle1.y.allcases), z = c(triangle1.z.con, triangle1.z.allcases),
                type = 'scatter3d', mode = 'lines',
      ...
      # Add popmean point
      plotly::add_trace(x = triangle1.x.popmean, y = triangle1.y.popmean, z = triangle1.z.popmean,
      ...
      # Add allcases point
      plotly::add_trace(x = triangle1.x.allcases,
      ...
      # Add con point
      plotly::add_trace(x = triangle1.x.con,
                y = triangle1.y.con,
                z = triangle1.z.con,
                type = 'scatter3d', mode = 'markers',
      ...
      # Add sub1 point
      plotly::add_trace(x = triangle1.x.sub1,
                y = triangle1.y.sub1,
                z = triangle1.z.sub1,
                type = 'scatter3d', mode = 'markers',
      ...
      # Add sub1 point
      plotly::add_trace(x = triangle2.x.sub1,
                y = triangle2.y.sub1,
                z = triangle2.z.sub1,
                type = 'scatter3d', mode = 'markers',
                marker = list(size = 6, color = 'white', line = list(color = "black", width = 3), symbol = "circle"),
      ...
      # Add sub2 point
      plotly::add_trace(x = triangle2.x.sub2,
                y = triangle2.y.sub2,
                z = triangle2.z.sub2,
                type = 'scatter3d', mode = 'markers',
      ...
      # Add sub2 point
      plotly::add_trace(x = triangle1.x.sub2,
                y = triangle1.y.sub2,
                z = triangle1.z.sub2,
                type = 'scatter3d', mode = 'markers',
                marker = list(size = 6, color = 'darkgray', line = list(color = "black", width = 3), symbol = "circle"),
    ...
    plotly::add_trace(x = c(triangle1.x.sub1, triangle1.x.sub2, triangle1.x.con),
      ...
      # Make the bottom triangle gray
      plotly::add_trace(x = c(triangle2.x.sub1, triangle2.x.sub2, triangle2.x.con),
